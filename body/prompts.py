MESSAGES = [
    {
        ...
        "content": (
            ...
            "supplementary-material, transcript, data-availability. Combined "
            "first-level titles use pipe: materials|methods, results|discussion. "
            "Do not pipe supplementary-material, transcript, or data-availability. "
            "Nested subsections only have title (omit sec_type). "
            "data-availability may add specific_use: data-available, "
